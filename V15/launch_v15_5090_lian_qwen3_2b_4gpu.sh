...
DIAG_DIR="${BASE_DIR}/diag_5090_Lian_v15_qwen3_2b_4gpu_${RUN_TAG}_$(date +%Y%m%d_%H%M%S)"
...
nohup env \
    ...
    WORK_DIR="${BASE_DIR}/v15" \
    RUNTIME_DIR="${BASE_DIR}/runtime_v15" \
    ...
    PROJECT_NAME=ArcherCodeR-V15-Qwen3-2B-5090Lian \
    EXP_NAME="train_5090_v15_qwen3_2b_4gpu_0_3_4_5_bsz32_save10_100_${RUN_TAG}" \
    OUTPUT_ROOT=./output_5090_Lian_v15 \
...
echo "TRAIN_DIR=${BASE_DIR}/v15/output_5090_Lian_v15/ArcherCodeR-V15-Qwen3-2B-5090Lian/train_5090_v15_qwen3_2b_4gpu_0_3_4_5_bsz32_save10_100_${RUN_TAG}"
