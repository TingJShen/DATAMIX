...
export EXP_NAME=${EXP_NAME:-train_5090_v13_qwen3_2b_5gpu_bsz40_save100}
export OUTPUT_ROOT=${OUTPUT_ROOT:-./output_5090_Lian}
export DYNAMIC_METHOD=${DYNAMIC_METHOD:-sample_taylor_v13}
export TOTAL_TRAINING_STEPS=${TOTAL_TRAINING_STEPS:-2000}
export SAVE_FREQ=${SAVE_FREQ:-100}

export TRAIN_PROMPT_BSZ=${TRAIN_PROMPT_BSZ:-40}
export TRAIN_PROMPT_MINI_BSZ=${TRAIN_PROMPT_MINI_BSZ:-10}
...
NATIVE_NUMPY_SHIM="${BASE_DIR}/v13/runtime_5090_lian/native_numpy_compat"
