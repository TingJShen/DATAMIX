...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        has_multi_modal_payload = self.image_key in row_dict or self.video_key in row_dict
        processor_has_chat_template = getattr(self.processor, "chat_template", None) is not None if self.processor is not None else False

        if self.processor is not None and (has_multi_modal_payload or processor_has_chat_template):
        ...
        has_vision_rope_inputs = (
            has_multi_modal_payload
