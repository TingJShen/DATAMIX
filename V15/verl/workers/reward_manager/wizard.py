    ...
    with ProcessPoolExecutor(max_workers=max_workers) as executor:
        ...
        for future in as_completed(futures):
            ...
            try:
                ...
                print(f"[reward error] idx={index} ground_truth={ground_truth[index]} err={e}")
                results[index] = 0.0
...
class WizardRewardManager:
    ...
    def verify(self, data, is_eval):
        ...
        ground_truth = [data_item.non_tensor_batch['reward_model'].get('ground_truth', '0') for data_item in data]
